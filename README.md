...
To build twemproxy 0.5.2+ from [distribution tarball](https://github.com/FalconSocial/twemproxy/releases):

    $ ./configure
    $ make
    $ sudo make install

To build twemproxy 0.5.2+ from [distribution tarball](https://github.com/FalconSocial/twemproxy/releases) in _debug mode_:
